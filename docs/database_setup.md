...
4. `supabase/migrations/20260506000004_tap_entries_updated_at.sql`
...
5. Banco já criado sem a coluna `tap_entries.updated_at` (rode a migration `20260506000004_tap_entries_updated_at.sql`)
